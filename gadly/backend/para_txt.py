...
class ML():
    def __init__(self):
        ...
        try: 
            self.vectorizer = load(r'~/gadly/gadly/backend/ML/joblib/vectorizer.joblib')
            self.classifier = load(r'~/gadly/gadly/backend/ML/joblib/classifier.joblib')
    ...
    def train(self):
        f = open(r'~/gadly/gadly/backend/ML/opensubtitles_inferred/opensubtitles_inferred.json')
        os_ds = json.load(f)
        ...
        dump(vectorizer, r'~/gadly/gadly/backend/ML/joblib/vectorizer.joblib')
        dump(classifier, r'~/gadly/gadly/backend/ML/joblib/classifier.joblib') 
